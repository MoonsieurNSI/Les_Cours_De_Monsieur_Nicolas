...
> [!WARNING]
> - **Avant de poursuivre quoi que ce soit, assurez-vous que votre dépot `github` est crée.**
> - Ajouter le script `setup.sh` (idéalement dans un dossier `source`, comme ici)
